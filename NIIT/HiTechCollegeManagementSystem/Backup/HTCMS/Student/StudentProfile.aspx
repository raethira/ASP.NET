<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentProfile.aspx.cs" Inherits="HTCMS.Student.StudentProfile" MasterPageFile="~/Student.Master" EnableSessionState="True"%>
            ...
            <table style="width: 765px">
                <tr>
                    ...
                    <td style="text-align: center; width: 382px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="TextBox5" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                        <br />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 382px; text-align: center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="TextBox7" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                        <br />
                    </td>
                </tr>
            </table>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox8" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
                <td style="text-align: center">
                    <asp:Label ID="Label14" runat="server" Text="Maritial Status:"></asp:Label>
&nbsp;
                    <asp:TextBox ID="TextBox13" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
            </tr>
            <tr>
...
&nbsp;
                    <asp:TextBox ID="TextBox9" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
                <td style="text-align: center">
                    <asp:Label ID="Label15" runat="server" Text="Hostellite:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox14" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox10" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
                <td style="text-align: center">
                    <asp:Label ID="Label16" runat="server" Text="Day Scholar:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox15" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
            </tr>
            <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox11" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
                <td style="text-align: center">
                    <asp:Label ID="Label17" runat="server" Text="Email:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox16" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br />
                </td>
            </tr>
            <tr>
...
&nbsp;
                    <asp:TextBox ID="TextBox12" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br/>
                </td>
                <td style="text-align: center">
                    <asp:Label ID="Label18" runat="server" Text="Mobile No.:"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:TextBox ID="TextBox17" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    <br/>
                </td>
            </tr>
        </table>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="text-align: center">
                        ...
                        &nbsp;&nbsp;<asp:TextBox ID="TextBox18" runat="server" ReadOnly="True" 
                            TextMode="MultiLine" BackColor="#CCCCCC"></asp:TextBox></td>
                    <td style="text-align: center">
                        <asp:Label ID="Label20" runat="server" Text="Residential Phone No.:"></asp:Label>
                        &nbsp; <asp:TextBox ID="TextBox19" runat="server" BackColor="#CCCCCC" 
                ...
                <tr>
                    <td style="text-align: center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:TextBox ID="TextBox20" runat="server" 
                            BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox><br />
                        </td>
                    <td style="text-align: center" rowspan="2">
                        <asp:Label ID="Label22" runat="server" Text="Father's Work Address:"></asp:Label>
                        &nbsp;&nbsp;<asp:TextBox ID="TextBox21" runat="server" BackColor="#CCCCCC" 
                ...
                <tr>
                    <td style="text-align: center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="TextBox26" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBox23" runat="server" 
                            BackColor="#CCCCCC" Height="22px" ReadOnly="True"></asp:TextBox><br />
                        </td>
                    <td style="text-align: center" rowspan="2">
                        <asp:Label ID="Label26" runat="server" Text="Mother's Work Address:"></asp:Label>
                        &nbsp;&nbsp;<asp:TextBox ID="TextBox25" runat="server" BackColor="#CCCCCC" 
                            ReadOnly="True" TextMode="MultiLine"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="text-align: center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="TextBox27" runat="server" BackColor="#CCCCCC" ReadOnly="True"></asp:TextBox>
                    </td>
                </tr>
            </table>
